...
public class ThymeleafService {
    ...
    public String getOTPContent(UserEntity userEntity, Integer otpnum) {
        ...
        context.setVariable("url", "http://localhost:3000/resetpassword?otp="+otpnum+"&email="+userEntity.getEmail());

        return templateEngine.process(Template.OTP_MAIL, context);
    }


    public String getVerifyContent(UserEntity userEntity, Integer otpnum) {
        final Context context = new Context();
