...
const Dashboard: React.FC = () => {
  ...
  const [responseWeekly] = useFetch(() => api.getWeeklyRevenue())
  const [responseToday] = useFetch(() => api.getTodayDashboard())
  const [responseMonthly] = useFetch(() => api.getMonthlyRevenue())
  ...
  const resultWeekly = responseWeekly?.map((value, index) => ({
    day: dayMap[index],
    value: value
  }))
  const resultMonthly = responseMonthly?.map((value, index) => ({
    day: monthMap[index],
    value: value
  }))
              ...
              <Card bordered={false} className='criclebox '>
                <div className='number'>
                  <Row align='middle' gutter={[24, 0]}>
                    ...
                    <Col xs={6}>
                      <div className='icon-box' style={{ background: '#E291C8' }}>
                        {c.icon}
                      </div>
                    </Col>
                  </Row>
